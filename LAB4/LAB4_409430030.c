...
int main(void)
{
    ...
    printf("# Check Timer0 ~ Timer1 interrupt counts are reasonable or not.\n\n");
    ...
    /* Check Timer0 ~ Timer1 interrupt counts */
    ...
    while(1)
    {
			...
			u8InChar = UART_READ(UART0);		
			  if(u8InChar == '1')
				...
				if(g_au32TMRINTCount[3] != u32InitCount)
        {
            printf("                           Count:%3d\n",g_au32TMRINTCount[3]);
            u32InitCount = g_au32TMRINTCount[3];
				}
					
						printf("TMR0:%3d\tTMR1:%3d\r ",g_au32TMRINTCount[0], g_au32TMRINTCount[1]);
